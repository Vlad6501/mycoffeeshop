...
<@c.page>
    <@p.product>
    <h1 class="h3 mb-3 text-center">Кофемашины</h1>
    <div class="col-md-auto">
        <p style="text-align: justify;">
            <img style="float: left; margin: 5px;" src="/img/DSC00480.jpg" alt="" width="240">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Кофемашины</li>
            </ol>
        </nav>
        <nav class=" shadow bg-white rounded pt-2 pb-3 pb-md-2">
            <div class="container d-flex align-items-md-center py-2">
                <nav class="nav mx-auto">
                    <a class="text-dark py-1 mr-3" href="/katalog/coffeemachines/professional">Профессиональные</a>
                    <a class="text-dark py-1 mr-3" href="/katalog/coffeemachines/horn">Рожковые</a>
                    <a class="text-dark py-1 mr-3" href="/katalog/coffeemachines/automatic">Автоматические</a>
                </nav>
            </div>
        </nav>
    </@p.product>
