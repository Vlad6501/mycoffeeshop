...
<@c.page>
    <@p.product>
        <h1 class="h3 mb-3 text-center">Аксессуары</h1>
        <div class="col-md-auto">
            <p style="text-align: justify;">
                <img style="float: left; margin: 5px;" src="/img/aksessuary-dlya-kofemashin-kofe-i-chaya-coffee-shop-net-ua.jpg" alt="" width="240">
        ...
        <nav class=" shadow bg-white rounded pt-2 pb-3 pb-md-2">
            <div class="container d-flex align-items-md-center py-2">
                <nav class="nav mx-auto">
                    <a class="text-dark py-1 mr-3" href="/katalog/accessories/tools">Инструменты Бариста </a>
                    <a class="text-dark py-1 mr-3" href="/katalog/accessories/tempers"> Темперы</a>
                    <a class="text-dark py-1 mr-3" href="/katalog/accessories/pitchers">Питчеры, молочники, джаги </a>
                    <a class="text-dark py-1 mr-3" href="/katalog/accessories/libra">Весы </a>
                </nav>
            </div>
        </nav>
    </@p.product>
